<?php
// $Id: main.php,v 1.7 2003/02/12 11:37:52 okazu Exp $
//%%%%%%		File Name index.php 		%%%%%
...
define('_NW_STORYLINK', 'Jump to the article');
define('_NW_MOREAUTHOR', 'Stories&nbsp;by');
define('_NW_SOURCE', 'Source');
define('_NW_MOVEUP', 'Move&nbsp;up');
